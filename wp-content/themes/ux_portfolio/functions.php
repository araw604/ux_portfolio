...
function portfolio_get_latest_posts( $post_type, $num_posts ) {
    $args = array(
      'post_type' => $post_type,
...
function red_starter_scripts() {
	...
	wp_enqueue_script( 'theme-scripts', get_template_directory_uri() . '/build/js/totaljs.min.js', array('jquery'), null, true );
